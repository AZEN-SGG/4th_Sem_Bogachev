...
class avl_tree
{
	...
	public:
		...
		// Solve 4
		static void number_elems_from_string_on_level (const avl_tree_node<T> *curr, const char *s, int level, int *levels);

		// Solve 5
		static int get_diff_btwn_num_elem_from_str_in_subtrees (const avl_tree_node<T> *curr, const char *s, int *max);
